...
\topmargin=-0.5in
\usepackage[margin=0.5in, right=2.5in, left=1in, top=.7in]{geometry}
\begin{document}
%\addtolength{\topmargin}{-.5in}
\name{\LARGE Jaiden Gerig} % the \\[11	pt] adds a blank line after name

\address{ \hspace*{0.8in} (512) 893-9148 $|$ jaideng123@yahoo.com $|$ 18549 Stone Ave N, Shoreline, WA 98133 \\  \rule{\textwidth}{0.1pt}}
